...
{
    public sealed class EntityFrameworkOptions<TPerm, TPermCat>
        where TPerm : Enum
        where TPermCat : Enum
    {
        ...
        public EntityFrameworkOptions<TPerm, TPermCat> AddCustomRolePermission<TRolePerm>()
        ...
        public EntityFrameworkOptions<TPerm, TPermCat> AddCustomTenant<TTenant>()
        ...
        public EntityFrameworkOptions<TPerm, TPermCat> AddCustomUserTenant<TUserTenant>()
        ...
        public EntityFrameworkOptions<TPerm, TPermCat> AddCustomUserTenantRole<TUserTenantRole>()
